...
**ListViewVirtualGroups / ListViewVirtualGroupsAdvanced** - Undocumented ListView Series Part 3: Using Group View with a virtual ListView (LVS_OWNERDATA). Ports of [[VB6, Vista+] Undocumented ListView feature: Groups in Virtual Mode](https://www.vbforums.com/showthread.php?808981-VB6-Vista-Undocumented-ListView-feature-Groups-in-Virtual-Mode). The Advanced version adds checkboxes.\
...
**cProgressWindowDemo** - A port of [[VB6] Class to display a standard Explorer-style progress window](https://www.vbforums.com/showthread.php?857409-VB6-Class-to-show-a-standard-Explorer-style-progress-window)
